...
static const struct ipu_sensor_config ipu_supported_sensors[] = {
	...
	/*
	 * Samsung/SmartSens SC200PC. No link frequencies listed, so the
	 * fwnode property is omitted and ISYS takes the rate from the
	 * sensor driver's V4L2_CID_LINK_FREQ control.
	 */
